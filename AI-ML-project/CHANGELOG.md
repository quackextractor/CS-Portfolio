...
- **Improved Config Flexibility**: Added support for both `"negative": true` and `"is_positive": false` in the batch extraction configuration for better consistency with common data labeling conventions.
